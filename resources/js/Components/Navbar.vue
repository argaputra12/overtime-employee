    ...
    <fwb-navbar class="shadow-md bg-primary">
        <template #logo>
            <fwb-navbar-logo
                ...
                image-url="https://www.svgrepo.com/show/414688/contractor-builder-15.svg"
                link="#"
            >
                ABC Construction
            </fwb-navbar-logo>
        ...
        >
            <fwb-navbar-collapse :is-show-menu="isShowMenu">
                <fwb-dropdown
                    v-if="!route().current().startsWith('manager')"
                    transition="fade"
                ...
                >
                    ...
                    <fwb-list-group>
                        <a href="/profile">
                            <fwb-list-group-item
                                :link="{ name: 'profile.edit' }"
                                :is-active="route().current('profile.edit')"
